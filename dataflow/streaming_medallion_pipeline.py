...
schema = {
    "fields": [
        ...
        {"name": "avg_heart_rate", "type": "FLOAT"},
        {"name": "avg_spo2", "type": "FLOAT"},
        {"name": "avg_temperature", "type": "FLOAT"},
        {"name": "max_risk_level", "type": "STRING"},
    ]
}
print("PROJECT:", PROJECT_ID)
print("TABLE:", BIGQUERY_TABLE)
print("TEMP:", TEMP_LOCATION)
# ------------------- Pipeline -------------------
with beam.Pipeline(options=pipeline_options) as p:
    ...
    tableId="patient_risk_analytics"
    )
